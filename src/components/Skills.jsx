  ...
  const skillCategories = [
    {
      ...
      skills: ['NLP', 'Agentic AI', 'Deep Learning', 'PyTorch', 'TensorFlow', 'Scikit-learn'],
      icon: (
    ...
    },
    {
      ...
      skills: ['Snowflake', 'Apache Airflow', 'Docker', 'Git', 'CI/CD', 'GCP'],
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      skills: ['Matplotlib', 'Power BI', 'Pandas', 'NumPy', 'Seaborn'],
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
